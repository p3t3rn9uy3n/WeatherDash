function initPage() {
    ...
    const nameEl = document.querySelector("#city");
    const currentPicEl = document.querySelector("#currentpic");
    const currentTempEl = document.querySelector("#temperature");
    const currentHumidityEl = document.querySelector("#humidity");4
    const currentWindEl = document.querySelector("#wind");
    const currentUVEl = document.querySelector("#uvindex");
